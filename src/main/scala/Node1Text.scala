object Node1Text {
 ...
 val text4a2: String = "Your hair--is it light or dark?"

 val text5b: String = "Long or short?"
 ...
 val text4b: String =
  """
    ...
    |(hairColor) hair. He has (beardType) And his eyes are emphatically (eyeColor).
    |So far you're scoring zero on the Know Thyself Questionnaire.
    |""".stripMargin
